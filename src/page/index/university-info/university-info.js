    ...
    render(){
        return (
            <div className={'university-info'}>
                ...
                <div className={`university-info-main animate__animated ${this.props.props1}`}>
                    <div className={'university-info-main-block'}></div>

                    <p className={'university-info-main-p'}>2020年6月毕业于广东肇庆学院计算机软件学院，大学本科专业是物联网工程</p>
                ...
                <div className={`university-info-title-container animate__animated ${this.props.props2}`}>
                    <p>教育背景</p>
                    <p>EDUCATIONAL</p>
                    <p>BACKGROUND</p>
                </div>
